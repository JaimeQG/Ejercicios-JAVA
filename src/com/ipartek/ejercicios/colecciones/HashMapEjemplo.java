...
public class HashMapEjemplo {
	...
	public static void main(String[] args) {
		...
		// meter 2 perros
		Perro p1 = new Perro("HasMap2", "cruce", 9.2f);
		Perro p2 = new Perro("HasMap1", "boxer", 6.1f);
		...
		Integer intObj = (Integer) id;

		hmPerros.put(intObj, p1);
		hmPerros.put((intObj + 1), p2);
		...
		// para poder ordenar Clases, debemos implementar la interfaz Comparable en la
		// propia clase

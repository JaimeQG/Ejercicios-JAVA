 ...
 *
 */
public class AppLibreriaSolucion extends AppGestionSolucion {

	private static LibroDaoSolucion dao = ImplLibroDaoSolucion.getInstance();
	private static String opcion = "";
	private static AppLibreriaSolucion app = new AppLibreriaSolucion();
	...
	protected void listar() {
		...
		for (LibroSolucion l : dao.getAll()) {
